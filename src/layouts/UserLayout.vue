...
<template>
  <div class="container mx-auto">
    ...
    <footer class="footer bg-base-200 text-base-content p-10">
      <aside>
        <img
          class="h-[200px] rounded-lg first-letter:object-cover"
          src="https://img.freepik.com/premium-photo/business-cat-office-suit-with-laptop_649938-139.jpg"
        />
        <p class="text-xl">
          Meow Industries Ltd.
          <br />
          Providing your lover since I was yours.
        </p>
      </aside>
      <nav>
